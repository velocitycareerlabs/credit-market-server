...
ARG FINERACT_SENTRY_ENVIRONMENT
ENV FINERACT_SENTRY_ENVIRONMENT=${FINERACT_SENTRY_ENVIRONMENT}

ARG FINERACT_SENTRY_RELEASE
ENV FINERACT_SENTRY_RELEASE=${FINERACT_SENTRY_RELEASE}
