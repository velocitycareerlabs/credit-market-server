...
VALUES
    (
    '000000005', '300', now(),
    now(), '1', 'VCL Market Maker',
    'VCL Market Maker', '0', now(),
    '1', '1', '2'
    ),
    (
    '000000006', '300', now(),
    now(), '1', 'VCL Petty Account',
    'VCL Petty Account', '0', now(),
    '1', '1', '2'
     );
...
VALUES
(
    '000000005', NULL, (select id from m_client where fullname = 'VCL Market Maker'), NULL,
...
(
    '000000006', NULL, (select id from m_client where fullname = 'VCL Petty Account'), NULL,
    NULL, '1', NULL, '300', '0', '1', '100',
    now(), '1', now(),
    '1', NULL, NULL, NULL, NULL, now(),
    '1', NULL, NULL, 'CRD', '2', '1', '0.000000',
