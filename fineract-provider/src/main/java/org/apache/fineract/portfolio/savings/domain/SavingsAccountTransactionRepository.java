...
public interface SavingsAccountTransactionRepository
    ...
    @Query("select sat from SavingsAccountTransaction sat where sat.dateOf between :currentActivationDate and :newActivationDate and sat.savingsAccount.id = :savingsId")
    List<SavingsAccountTransaction> findAllTransactionBetweenDates(@Param("currentActivationDate") Date currentActivationDate,
            @Param("newActivationDate") Date newActivationDate, @Param("savingsId") Long savingsId);
